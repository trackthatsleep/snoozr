...
If you prefer to also extract more granular 30-second epoch data, there is an option for this as well, though be aware that parsing of this resolution can be quite time-consuming. When this option is set to TRUE, the data frame returned repeats event-level data for each instance of unique 30-second epoch data (i.e., it returns a dataset amenable to multilevel modeling)

```{r person_epoc, echo = T, eval = F}
